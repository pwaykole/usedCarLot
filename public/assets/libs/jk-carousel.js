...
(function () {
    ...
    function CarouselController($timeout, $attrs, $interval, $window) {
        ...
        that.scaleMarginLeft = function (newSlidesContainerWidth) {
            if (that.currentSlidesContainerWidth && that.currentSlidesContainerWidth !== newSlidesContainerWidth) {
    ...
    angular.module('jkAngularCarousel').controller('JKCarouselController', [
